CLASS zcl_16_table_type DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_16_TABLE_TYPE IMPLEMENTATION.
...
* Task 1
**********************************************************************
    DATA addresses TYPE z16t_adresses.
...
* Task 2
**********************************************************************
    DATA person TYPE z16s_person_deep.
...
* Task 3
**********************************************************************
    DATA persons TYPE z16t_persons.
